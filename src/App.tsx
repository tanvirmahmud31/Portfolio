...
import { JourneyTimeline } from "./components/JourneySection/JourneyTimeline";
import { ContactSection } from "./components/ContactSection/ContactSection";
import { Footer } from "./components/Footer/Footer";
import ReactLenis from "lenis/react";
import { Home, User, GraduationCap, Route, FolderKanban, Send } from "lucide-react";
...
function App() {
  ...
  const dockItems = [
    ...
    { icon: <Route size={20} />, label: "Journey", onClick: () => scrollToSection("journey") },
